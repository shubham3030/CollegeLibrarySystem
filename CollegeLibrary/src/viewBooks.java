	 ...
	 JTable table;
	   ...
	   public static void main(String args[]){
		      EventQueue.invokeLater(new Runnable(){
		    	 public void run(){
		    		 try{
		    		 frame=new viewBooks("NITJ LIBRARY");
	   ...
	   public viewBooks(String s){
		...
		//	contentPane = new JPanel();
		    ...
		    try{
		    	...
		    	PreparedStatement ps=con.prepareStatement("Select * from addBooks",ResultSet.TYPE_SCROLL_SENSITIVE,ResultSet.CONCUR_UPDATABLE);
